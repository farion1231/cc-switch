...
### Claude Code、Claude Desktop、Codex、Gemini CLI、Grok Build、OpenCode、VS Code Copilot、GitHub Copilot CLI、OpenClaw、Hermes Agent、MiniMax Code のオールインワン管理ツール
...
最新の AI コーディングは Claude Code、Claude Desktop、Codex、Gemini CLI、Grok Build、OpenCode、VS Code Copilot、GitHub Copilot CLI、OpenClaw、Hermes、MiniMax Code などのツールに依存していますが、各ツールの設定形式はバラバラです。API プロバイダを切り替えるたびに JSON、TOML、`.env` ファイルを手動で編集する必要があり、複数ツール間で MCP や Skills を統一的に管理する手段もありません。
...
- **1 つのアプリで 11 個のツール** -- Claude Code、Claude Desktop、Codex、Gemini CLI、Grok Build、OpenCode、VS Code Copilot、GitHub Copilot CLI、OpenClaw、Hermes、MiniMax Code を単一インターフェースで管理
- **手動編集は不要** -- AWS Bedrock、NVIDIA NIM、コミュニティリレーなど 50 以上のプロバイダプリセットを内蔵。選んで切り替えるだけ
- **統一 MCP・Skills 管理** -- 1 つのパネルで Claude、Codex、Gemini、Grok Build、OpenCode、VS Code Copilot、GitHub Copilot CLI、Hermes、MiniMax Code の MCP サーバーと Skills を双方向同期で管理
...
- **11 個の対応ツール、50 以上のプリセット** -- Claude Code、Claude Desktop、Codex、Gemini CLI、Grok Build、OpenCode、VS Code Copilot、GitHub Copilot CLI、OpenClaw、Hermes、MiniMax Code。キーをコピーしてワンクリックでインポート
...
- **統一 MCP パネル** -- Claude、Codex、Gemini、Grok Build、OpenCode、VS Code Copilot、GitHub Copilot CLI、Hermes、MiniMax Code の MCP サーバーを管理、双方向同期、Deep Link インポート対応
...
CC Switch は **Claude Code**、**Claude Desktop**、**Codex**、**Gemini CLI**、**Grok Build**、**OpenCode**、**VS Code Copilot**、**GitHub Copilot CLI**、**OpenClaw**、**Hermes**、**MiniMax Code** の 11 個のツールに対応しています。各ツールに専用のプロバイダプリセットと設定管理が用意されています。**VS Code Copilot** と **GitHub Copilot CLI** は、プロバイダーカタログとセッションが分離された独立のファーストクラスアプリです。GitHub Copilot デスクトップアプリは管理対象外です。
