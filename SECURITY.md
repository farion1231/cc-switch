...
Only the latest release of EC Switch receives security updates.

仅最新版本的 EC Switch 会收到安全更新。
...
Instead, please report them through [GitHub Security Advisories](https://github.com/farion1231/ec-switch/security/advisories/new).

请通过 [GitHub 安全公告](https://github.com/farion1231/ec-switch/security/advisories/new) 进行报告。
...
Security fixes are released as patch versions and announced via [GitHub Releases](https://github.com/farion1231/ec-switch/releases). We recommend always updating to the latest version.

安全修复通过补丁版本发布，并通过 [GitHub Releases](https://github.com/farion1231/ec-switch/releases) 通知。建议始终更新到最新版本。
