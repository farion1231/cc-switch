...
impl McpApps {
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Mimo => self.mimo = enabled,
...
impl FromStr for AppType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            "mimo" | "mimocode" | "mimo-code" | "mimo_code" => Ok(AppType::Mimo),
            "openclaw" => Ok(AppType::OpenClaw),
            "hermes" => Ok(AppType::Hermes),
            other => Err(AppError::localized(
                "unsupported_app",
                format!("不支持的应用标识: '{other}'。可选值: claude, claude-desktop, codex, gemini, opencode, mimo, openclaw, hermes。"),
                format!("Unsupported app id: '{other}'. Allowed: claude, claude-desktop, codex, gemini, opencode, mimo, openclaw, hermes."),
            )),
        }
    }
}
...
impl CommonConfigSnippets {
    ...
    pub fn set(&mut self, app: &AppType, snippet: Option<String>) {
        match app {
            ...
            AppType::Mimo => self.mimo = snippet,
...
impl Default for MultiAppConfig {
    fn default() -> Self {
        ...
        apps.insert("mimo".to_string(), ProviderManager::default());
...
impl MultiAppConfig {
    ...
    pub fn mcp_for_mut(&mut self, app: &AppType) -> &mut McpConfig {
        match app {
            ...
            AppType::Mimo => &mut self.mcp.mimo,
    ...
    fn default_with_auto_import() -> Result<Self, AppError> {
        ...
        Self::auto_import_prompt_if_exists(&mut config, AppType::Mimo)?;
    ...
    fn maybe_auto_import_prompts_for_existing_config(&mut self) -> Result<bool, AppError> {
        ...
        if !self.prompts.claude.prompts.is_empty()
            ...
            || !self.prompts.mimo.prompts.is_empty()
    ...
    fn auto_import_prompt_if_exists(config: &mut Self, app: AppType) -> Result<bool, AppError> {
        ...
        let prompts = match app {
            ...
            AppType::Mimo => &mut config.prompts.mimo.prompts,
    ...
    pub fn migrate_mcp_to_unified(&mut self) -> Result<bool, AppError> {
        ...
        for app in [
            ...
            let old_servers = match app {
                ...
                AppType::Mimo => &self.mcp.mimo.servers,
        ...
        self.mcp.mimo = McpConfig::default();
