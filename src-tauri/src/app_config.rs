...
impl McpApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Omp => false, // OMP MCP integration is not managed here.
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Omp => {}           // OMP MCP integration is not managed here.
...
impl FromStr for AppType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            "pi" => Ok(AppType::Pi),
            "omp" | "oh-my-pi" | "oh_my_pi" => Ok(AppType::Omp),
...
impl MultiAppConfig {
    ...
    fn auto_import_prompt_if_exists(config: &mut Self, app: AppType) -> Result<bool, AppError> {
        ...
        let prompts = match app {
            ...
            AppType::Pi | AppType::Omp => return Ok(false),
        };
