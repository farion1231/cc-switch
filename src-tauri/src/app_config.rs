...
impl McpApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::WorkBuddy => false, // WorkBuddy 不通过本工具管理 MCP
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::WorkBuddy => {}     // WorkBuddy 不支持 MCP，忽略
...
impl SkillApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::WorkBuddy => false, // WorkBuddy 不通过本工具管理 Skills
            AppType::ClaudeDesktop => false,
        }
    }
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::WorkBuddy => {} // WorkBuddy 不支持 Skills，忽略
...
impl FromStr for AppType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            "pi" => Ok(AppType::Pi),
            "workbuddy" | "work-buddy" | "work_buddy" | "codebuddy" => Ok(AppType::WorkBuddy),
...
impl MultiAppConfig {
    ...
    fn auto_import_prompt_if_exists(config: &mut Self, app: AppType) -> Result<bool, AppError> {
        ...
        let prompts = match app {
            ...
            // Pi and WorkBuddy were added after prompts moved to SQLite. Keeping
            // them out of this legacy config avoids a second, unused prompt state.
            AppType::Pi | AppType::WorkBuddy => return Ok(false),
        };
    ...
    pub fn migrate_mcp_to_unified(&mut self) -> Result<bool, AppError> {
        ...
        for app in [
            ...
            let old_servers = match app {
                ...
                AppType::WorkBuddy => continue, // WorkBuddy 不涉及 v3.6.x MCP 迁移
            };
