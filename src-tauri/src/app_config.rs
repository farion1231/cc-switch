...
impl McpApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::StepCode => false, // StepCode MCP sync not yet supported
        }
    }
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::StepCode => {}      // StepCode MCP sync not yet supported
        }
    }
...
impl SkillApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::ClaudeDesktop => false,
            AppType::StepCode => false, // StepCode Skills sync not yet supported
        }
    }
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::StepCode => {}      // StepCode Skills sync not yet supported
        }
    }
...
impl FromStr for AppType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            "stepcode" => Ok(AppType::StepCode),
            other => Err(AppError::localized(
                "unsupported_app",
                format!("不支持的应用标识: '{other}'。可选值: claude, claude-desktop, codex, gemini, grokbuild, opencode, openclaw, hermes, pi, mcode, stepcode。"),
                format!("Unsupported app id: '{other}'. Allowed: claude, claude-desktop, codex, gemini, grokbuild, opencode, openclaw, hermes, pi, mcode, stepcode."),
            )),
        }
    }
}
...
impl CommonConfigSnippets {
    ...
    pub fn get(&self, app: &AppType) -> Option<&String> {
        match app {
            ...
            AppType::Pi | AppType::Mcode | AppType::StepCode => None,
        }
    }
    ...
    pub fn set(&mut self, app: &AppType, snippet: Option<String>) {
        match app {
            ...
            AppType::Pi | AppType::Mcode | AppType::StepCode => {}
        }
    }
}
...
impl MultiAppConfig {
    ...
    fn auto_import_prompt_if_exists(config: &mut Self, app: AppType) -> Result<bool, AppError> {
        ...
        let prompts = match app {
            ...
            AppType::Pi | AppType::Mcode | AppType::StepCode => return Ok(false),
        };
    ...
    pub fn migrate_mcp_to_unified(&mut self) -> Result<bool, AppError> {
        ...
        for app in [
            ...
            let old_servers = match app {
                ...
                AppType::Pi | AppType::Mcode | AppType::StepCode => continue, // Pi/Mcode/StepCode didn't exist in v3.6.x, skip
            };
