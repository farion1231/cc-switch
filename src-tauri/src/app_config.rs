...
impl McpApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Pi => false, // Pi doesn't support MCP yet
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Pi => {} // Pi doesn't support MCP yet, ignore
...
impl SkillApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Pi => false, // Pi doesn't support Skills yet
            AppType::ClaudeDesktop => false,
        }
    }
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Pi => {} // Pi doesn't support Skills yet, ignore
