...
//!
//! Parses ccdoctor:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ccdoctor:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ccdoctor://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ccdoctor" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ccdoctor', got '{scheme}'"
        )));
    }
