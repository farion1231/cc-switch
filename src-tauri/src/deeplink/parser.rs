...
//!
//! Parses ecswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ecswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ecswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ecswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ecswitch', got '{scheme}'"
        )));
    }
