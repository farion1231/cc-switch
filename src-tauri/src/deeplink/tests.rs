...
fn test_parse_valid_claude_deeplink() {
    let url = "ecswitch://v1/import?resource=provider&app=claude&name=Test%20Provider&homepage=https%3A%2F%2Fexample.com&endpoint=https%3A%2F%2Fapi.example.com&apiKey=sk-test-123&icon=claude";
...
fn test_parse_deeplink_with_notes() {
    let url = "ecswitch://v1/import?resource=provider&app=codex&name=Codex&homepage=https%3A%2F%2Fcodex.com&endpoint=https%3A%2F%2Fapi.codex.com&apiKey=key123&notes=Test%20notes";
...
fn test_parse_unsupported_version() {
    let url = "ecswitch://v2/import?resource=provider&app=claude&name=Test";
...
fn test_parse_missing_required_field() {
    ...
    let url = "ecswitch://v1/import?resource=provider&app=claude";
...
fn test_import_prompt_allows_space_in_base64_content() {
    ...
    let url = "ecswitch://v1/import?resource=prompt&app=codex&name=PromptPlus&content=Pj4+";
    let request = parse_deeplink_url(url).unwrap();
...
fn test_parse_prompt_deeplink() {
    ...
    let url = format!(
        "ecswitch://v1/import?resource=prompt&app=claude&name=test&content={}&description=desc&enabled=true",
        content_b64
    );
...
fn test_parse_mcp_deeplink() {
    ...
    let url = format!(
        "ecswitch://v1/import?resource=mcp&apps=claude,codex&config={}&enabled=true",
        config_b64
    );
...
fn test_parse_skill_deeplink() {
    let url = "ecswitch://v1/import?resource=skill&repo=owner/repo&directory=skills&branch=dev";
    let request = parse_deeplink_url(url).unwrap();
...
fn test_parse_multiple_endpoints_comma_separated() {
    let url = "ecswitch://v1/import?resource=provider&app=claude&name=Test&endpoint=https%3A%2F%2Fapi1.example.com,https%3A%2F%2Fapi2.example.com,https%3A%2F%2Fapi3.example.com&apiKey=sk-test";
...
fn test_parse_single_endpoint_backward_compatible() {
    ...
    let url = "ecswitch://v1/import?resource=provider&app=claude&name=Test&endpoint=https%3A%2F%2Fapi.example.com&apiKey=sk-test";
...
fn test_parse_endpoints_with_spaces_trimmed() {
    let url = "ecswitch://v1/import?resource=provider&app=claude&name=Test&endpoint=https%3A%2F%2Fapi1.example.com%20,%20https%3A%2F%2Fapi2.example.com&apiKey=sk-test";
