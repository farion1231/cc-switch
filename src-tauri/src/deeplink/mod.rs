//! Deep link import functionality for EC Switch
//!
//! This module implements the ecswitch:// protocol for importing configurations
...
///
/// Represents a parsed ecswitch:// URL ready for processing.
