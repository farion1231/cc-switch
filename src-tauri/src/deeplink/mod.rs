//! Deep link import functionality for CC Doctor
//!
//! This module implements the ccdoctor:// protocol for importing configurations
...
///
/// Represents a parsed ccdoctor:// URL ready for processing.
