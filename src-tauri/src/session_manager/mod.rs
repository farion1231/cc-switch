...
use providers::{antigravity, claude, codex, gemini, hermes, openclaw, opencode};
...
pub fn scan_sessions() -> Vec<SessionMeta> {
    let (r1, r2, r3, r4, r5, r6, r7) = std::thread::scope(|s| {
        ...
        let h7 = s.spawn(antigravity::scan_sessions);
        (
    ...
    for root in roots {
        ...
        if validated_source.starts_with(&validated_root) {
            return match provider_id {
                ...
                "antigravity" => {
                    antigravity::delete_session(&validated_root, &validated_source, session_id)
                }
...
fn provider_roots(provider_id: &str) -> Result<Vec<PathBuf>, String> {
    let roots = match provider_id {
        ...
        "antigravity" => antigravity::session_roots(),
