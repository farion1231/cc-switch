    ...
    transaction
        .execute(
            "INSERT INTO proxy_request_logs (
                request_id, provider_id, app_type,
...
mod tests {
    ...
    #[test]
    fn upsert_usage_event_persists_tokens_and_fresh_input_semantics() {
        ...
        let stored: (i64, i64, i64, Option<i64>, Option<i64>) = conn
            .query_row(
                "SELECT input_tokens, output_tokens, input_token_semantics,
        ...
        assert_eq!(
            stored,
            (120, 30, INPUT_TOKEN_SEMANTICS_FRESH, Some(3), Some(15))
        );
    }
