...
pub fn get_app_config_dir() -> PathBuf {
    if let Some(custom) = crate::app::app_store::get_app_config_dir_override() {
        return custom;
    }
...
pub fn get_provider_config_path(provider_id: &str, provider_name: Option<&str>) -> PathBuf {
    ...
    crate::live_config::claude_code::get_claude_config_dir()
        .join(format!("settings-{base_name}.json"))
}
...
mod tests {
    use super::*;
    use crate::live_config::claude_code::{
        default_mcp_path_for_config_dir, derive_mcp_path_from_override,
    };
