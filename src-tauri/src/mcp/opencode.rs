...
//!
//! 本模块处理 EC Switch 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | EC Switch 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: EC Switch → OpenCode
// ============================================================================

/// Convert EC Switch unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → EC Switch
// ============================================================================

/// Convert OpenCode format to EC Switch unified format
///
/// Conversion rules:
