...
//!
//! Handles conversion between EC Switch unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | EC Switch unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// EC Switch has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: EC Switch -> Hermes
// ============================================================================

/// Convert EC Switch unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> EC Switch
// ============================================================================

/// Convert Hermes format to EC Switch unified format
///
/// Conversion rules:
...
/// `existing` — this prevents EC Switch from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive EC Switch round-trip"
        );
    }
