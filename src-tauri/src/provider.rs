...
pub struct ProviderMeta {
    ...
    /// Active model for a mirrored DeepSeek Harness native provider.
    #[serde(rename = "dshCurrentModel", skip_serializing_if = "Option::is_none")]
    pub dsh_current_model: Option<String>,
