...
fn settings_contain_common_config(app_type: &AppType, settings: &Value, snippet: &str) -> bool {
    ...
    match app_type {
        ...
        AppType::OpenCode | AppType::OpenClaw | AppType::Hermes | AppType::ZCode | AppType::ClaudeDesktop => false,
    }
}
...
pub(crate) fn remove_common_config_from_settings(
    ...
    match app_type {
        ...
        AppType::OpenCode | AppType::OpenClaw | AppType::Hermes | AppType::ZCode | AppType::ClaudeDesktop => {
            Ok(settings.clone())
        }
    }
}
