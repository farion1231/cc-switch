...
"#;
    ...
    fn sync_current_provider_for_app_preserves_legacy_live_opencode_provider() {
        with_test_home(|state, _| {
            ...
            updated.settings_config["options"]["apiKey"] = Value::String("updated-FAKE_KEY".to_string());
            state
                .db
    ...
    fn opencode_write_back_splits_auth_field_to_auth_json() {
        with_test_home(|state, _| {
            ...
            let auth_entry = crate::opencode_config::get_opencode_auth_entry("split-auth-provider")
                .expect("read auth.json");
            assert_eq!(
                auth_entry,
            ...
            let live_providers =
                crate::opencode_config::get_providers().expect("read opencode providers");
            let live = live_providers.get("split-auth-provider").expect("provider exists");
            assert!(live.get("auth").is_none(), "auth should not be in opencode.json");
            assert_eq!(
    ...
    fn opencode_write_back_splits_legacy_api_key_to_auth_json() {
        with_test_home(|state, _| {
            ...
            let live_providers =
                crate::opencode_config::get_providers().expect("read opencode providers");
            let live = live_providers.get("legacy-key-provider").expect("provider exists");
            assert_eq!(
                live.pointer("/options/apiKey"),
                None,
    ...
    fn opencode_write_back_creates_auth_json_if_missing() {
        with_test_home(|state, _| {
            ...
            let auth_entry = crate::opencode_config::get_opencode_auth_entry("new-auth-provider")
                .expect("read auth.json");
            assert!(
                auth_entry.is_some(),
    ...
    fn opencode_write_back_preserves_unrelated_auth_entries() {
        with_test_home(|state, _| {
            ...
            let other_entry = crate::opencode_config::get_opencode_auth_entry("other-provider")
                .expect("read auth.json");
            assert_eq!(
                other_entry,
            ...
            let new_entry = crate::opencode_config::get_opencode_auth_entry("split-provider")
                .expect("read auth.json");
    ...
    fn opencode_round_trip_clean_split() {
        with_test_home(|state, _| {
            ...
            let saved = state
                ...
                .expect("exists");
            assert_eq!(
                saved.settings_config.pointer("/auth/key").and_then(|v| v.as_str()),
            ...
            let auth_entry = crate::opencode_config::get_opencode_auth_entry("round-trip-provider")
                .expect("read auth.json");
            assert_eq!(
                auth_entry,
            ...
            let live_providers =
                crate::opencode_config::get_providers().expect("read opencode providers");
            let live = live_providers.get("round-trip-provider").expect("provider exists");
            assert_eq!(
                live.pointer("/options/apiKey"),
                None,
    ...
    fn opencode_write_back_still_writes_provider_definition_when_auth_json_invalid() {
        with_test_home(|state, _| {
            ...
            let live_providers =
                crate::opencode_config::get_providers().expect("read opencode providers");
            let live = live_providers.get("def-only-provider").expect("provider definition should exist");
            assert_eq!(
                live.pointer("/options/baseURL"),
                Some(&json!("https://api.example.com/v1")),
    ...
    fn opencode_oauth_fields_preserved_in_auth_json() {
        with_test_home(|state, _| {
            ...
            let saved = state
                ...
                .expect("exists");
            assert_eq!(
                saved.settings_config.pointer("/auth/type").and_then(|v| v.as_str()),
                Some("oauth"),
                "imported auth should have type=oauth"
            );
            assert_eq!(
                saved.settings_config.pointer("/auth/accountId").and_then(|v| v.as_str()),
                Some("acct_FAKE"),
            ...
            let auth_entry = crate::opencode_config::get_opencode_auth_entry("oauth-provider")
                .expect("read auth.json")
                .expect("entry exists");
            assert_eq!(auth_entry.get("type").and_then(|v| v.as_str()), Some("oauth"));
            assert_eq!(auth_entry.get("refresh").and_then(|v| v.as_str()), Some("FAKE_REFRESH"));
            assert_eq!(auth_entry.get("access").and_then(|v| v.as_str()), Some("FAKE_ACCESS"));
            assert_eq!(auth_entry.get("expires").and_then(|v| v.as_u64()), Some(1234567890));
            assert_eq!(auth_entry.get("accountId").and_then(|v| v.as_str()), Some("acct_FAKE"));
        });
    }
