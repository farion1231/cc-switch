...
const SYNC_SKIP_SETTINGS_KEYS: &[&str] = &["codex_usage_canonical_replay_v1"];
    ...
    fn sync_isolates_codex_replay_tables_and_state_but_syncs_other_settings() -> Result<(), AppError>
    {
        ...
        full_target.import_sql_string(&full_sql)?;
        {
            ...
            assert_eq!(
                ...
                "full imports must retain the Codex replay state row"
            );
        }
        ...
        assert_eq!(replay_state, "local-pending");
