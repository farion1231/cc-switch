...
impl Database {
    ...
    /// 口径: 2026-07-13 厂商 standard/list 文本 token 价（USD / 1M tokens）。
    /// 本平面表不表达 batch/flex/priority、长上下文阶梯、区域附加费、工具调用或音视频价格。
    fn seed_model_pricing(conn: &Connection) -> Result<(), AppError> {
        let pricing_data = [
            ...
            // GPT-5.6 系列（2026-07-09 OpenAI 官方 standard 价）
            // GPT-5.6 起显式 cache write 按未缓存输入的 1.25 倍计费。
            ...
            ("gpt-5-pro", "GPT-5 Pro", "15", "120", "0", "0"),
            ...
            // 兼容别名：2026-07-24 下线前均路由到 V4 Flash。
            (
                "deepseek-chat",
            ...
            ("glm-4.5", "GLM-4.5", "0.6", "2.2", "0.11", "0"),
            ("glm-4.5-x", "GLM-4.5 X", "2.2", "8.9", "0.45", "0"),
            ("glm-4.5-air", "GLM-4.5 Air", "0.2", "1.1", "0.03", "0"),
            ("glm-4.5-airx", "GLM-4.5 AirX", "1.1", "4.5", "0.22", "0"),
            ("glm-4.5-flash", "GLM-4.5 Flash", "0", "0", "0", "0"),
            (
                "glm-4-32b-0414-128k",
                "GLM-4 32B 0414 128K",
                "0.1",
            ...
            ("grok-4.5-latest", "Grok 4.5", "2", "6", "0.50", "0"),
            ...
            (
                ...
                "Grok 4.3 (Grok 4.1 Fast Reasoning Alias)",
                "1.25",
                "2.50",
                "0.20",
                "0",
            ...
            // Cohere 新模型的共享 API 当前按调用限额免费；私有部署价格由合同决定。
            (
    ...
    fn repair_current_model_pricing(conn: &Connection) -> Result<(), AppError> {
        let pricing_fixes = [
            ...
            // 2026-07-13：DeepSeek 兼容别名已切到 V4 Flash 的实际计费。
            (
                "deepseek-chat",
                "DeepSeek V4 Flash (Chat Alias)",
                "0.14",
            ...
            // Mistral Small 4 GA list 价；官方未列单独 cache token 折扣。
            (
                "mistral-small-4",
                "Mistral Small 4",
                "0.15",
            ...
            // Gemini 3.5 Flash 2026-06 GA 后的 standard 价。
            (
                "gemini-3.5-flash",
                "Gemini 3.5 Flash",
                "2.70",
            ...
            // xAI 于 2026-05-15 退役以下旧 slug；请求会转到 Grok 4.3 并按 4.3 计费。
            (
                "grok-4-1-fast-reasoning",
                "Grok 4.3 (Grok 4.1 Fast Reasoning Alias)",
                "1.25",
