...
impl Database {
    ...
    pub fn get_all_mcp_servers(&self) -> Result<IndexMap<String, McpServer>, AppError> {
        ...
        let mut stmt = conn.prepare(
            "SELECT id, name, server_config, description, homepage, docs, tags, enabled_claude, enabled_claude_xcode, enabled_codex, enabled_gemini, enabled_opencode, enabled_hermes
             FROM mcp_servers
        ...
        let server_iter = stmt
            .query_map([], |row| {
                ...
                let enabled_claude_xcode: bool = row.get(8)?;
                ...
                Ok((
                    ...
                    McpServer {
                        ...
                        apps: McpApps {
                            ...
                            claude_xcode: enabled_claude_xcode,
                            codex: enabled_codex,
    ...
    pub fn save_mcp_server(&self, server: &McpServer) -> Result<(), AppError> {
        ...
        conn.execute(
            "INSERT OR REPLACE INTO mcp_servers (
                ...
                enabled_claude, enabled_claude_xcode, enabled_codex, enabled_gemini, enabled_opencode, enabled_hermes
