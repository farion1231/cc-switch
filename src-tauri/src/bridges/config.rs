...
use crate::services::omo::{
    OmoService as LegacyOmoService, SLIM as LEGACY_SLIM, STANDARD as LEGACY_STANDARD,
};
...
pub fn legacy_extract_common_config_snippet(
    ...
    match settings_config {
        Some(settings) => {
            LegacyProviderService::extract_common_config_snippet_from_settings(app_type, &settings)
        }
        None => {
...
pub fn extract_common_config_snippet(
    ...
    match settings_config {
        Some(settings) => {
            cc_switch_core::ProviderService::extract_common_config_snippet_from_settings(
