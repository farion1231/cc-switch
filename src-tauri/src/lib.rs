...
/// This handles the case where the window was hidden while fullscreen —
/// the fullscreen state may persist and cause the window to appear as
/// borderless fullscreen when shown again.
#[cfg(target_os = "macos")]
