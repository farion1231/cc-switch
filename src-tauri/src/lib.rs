...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_provider_security_status,
            commands::import_live_provider_credentials,
            commands::recover_app_configuration,
            ...
            commands::list_codex_user_scripts,
            ...
            commands::reinject_after_script_change,
            commands::get_codex_effective_home,
            commands::get_codex_plugin_marketplace_status,
            ...
            commands::webdav_sync_prepare_download,
            commands::webdav_sync_apply_download,
            ...
            commands::s3_sync_prepare_download,
            commands::s3_sync_apply_download,
