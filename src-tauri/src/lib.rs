...
pub fn run() {
    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            // Only register the updater when this build has an update feed.
            #[cfg(desktop)]
            {
                if !commands::app_updates_enabled(app.handle()) {
                    log::info!("Application update checks are disabled for this build.");
