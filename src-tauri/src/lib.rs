...
pub fn run() {
    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            // Copy only after normalizing the legacy fixed official card. This
            // prevents Codex Desktop from inheriting an obsolete managed-account
            // binding that the CLI migration immediately splits into its own row.
