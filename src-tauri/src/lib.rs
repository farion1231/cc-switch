        ...
        Ok(request) => {
            ...
            if focus_main_window {
                if let Some(window) = app.get_webview_window("main") {
                    ...
                    #[cfg(target_os = "linux")]
                    {
                        linux_fix::reactivate_main_window(window.clone(), "deeplink");
                    }
    ...
    #[cfg(any(target_os = "macos", target_os = "windows", target_os = "linux"))]
    {
        builder = builder.plugin(tauri_plugin_single_instance::init(|app, args, _cwd| {
            ...
            if let Some(window) = app.get_webview_window("main") {
                ...
                #[cfg(target_os = "linux")]
                {
                    linux_fix::reactivate_main_window(window.clone(), "single-instance");
                }
            }
        }));
    }
        ...
        .setup(|app| {
            ...
            if let Some(window) = app.get_webview_window("main") {
                ...
                if settings.silent_startup {
                    ...
                    #[cfg(target_os = "linux")]
                    {
                        linux_fix::reactivate_main_window(window.clone(), "startup");
                    }
                }
            }
