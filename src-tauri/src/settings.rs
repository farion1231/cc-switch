...
pub struct AppSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub codebuddy_config_dir: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub workbuddy_config_dir: Option<String>,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            pi_config_dir: None,
            codebuddy_config_dir: None,
            workbuddy_config_dir: None,
...
impl AppSettings {
    ...
    fn normalize_paths(&mut self) {
        ...
        self.codebuddy_config_dir = self
        ...
        self.workbuddy_config_dir = self
...
pub fn get_codebuddy_override_dir() -> Option<PathBuf> {
    let settings = settings_store().read().ok()?;
    settings
        .codebuddy_config_dir
        .as_ref()
