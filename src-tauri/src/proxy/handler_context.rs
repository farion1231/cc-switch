...
pub struct RequestContext {
    ...
    /// The base URL that produced the final upstream response. It is populated
    /// only after forwarding succeeds, so retries cannot be attributed to an
    /// earlier failed target.
    pub upstream_endpoint_url: Option<String>,
