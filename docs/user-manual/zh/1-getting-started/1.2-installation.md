...
请只从 **[ecswitch.io](https://ecswitch.io)**、**[GitHub Releases](https://github.com/farion1231/ec-switch/releases)** 或项目源码仓库获取 EC Switch。任何要求付费、充值或索取登录凭据的“EC Switch”网站或客户端都不是官方渠道。
...
EC Switch 管理的 CLI 工具（Claude Code、Codex、Gemini CLI）需要 Node.js 环境。
...
1. 访问 [Releases 页面](https://github.com/farion1231/ec-switch/releases)
...
2. 打开 DMG，或解压 zip 得到 `EC Switch.app`
3. 拖动到「应用程序」文件夹

### 已签名并公证

EC Switch macOS 版本已通过 Apple 代码签名和公证，可直接安装打开，无需额外操作。
