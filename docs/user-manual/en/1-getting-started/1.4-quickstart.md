...
- Right-click the EC Switch icon in the system tray
...
If Claude Code prompts you to **log in** or shows an onboarding wizard on first launch, enable the "Skip Claude Code first-run confirmation" option in EC Switch:

1. Open EC Switch "Settings > General"
