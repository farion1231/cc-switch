...
The checkbox state is remembered: once you have enabled Lightweight Mode, closing the main window again or restarting the app automatically returns to Lightweight Mode until you uncheck the toggle.
