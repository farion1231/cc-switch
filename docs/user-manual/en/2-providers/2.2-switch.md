...
2. CC Doctor updates the configuration file
...
1. Right-click the CC Doctor icon in the system tray
...
When switching providers, CC Doctor modifies the following files:
