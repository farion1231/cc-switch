...
2. EC Switch updates the configuration file
...
1. Right-click the EC Switch icon in the system tray
...
When switching providers, EC Switch modifies the following files:
