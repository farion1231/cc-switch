...
EC Switch provides rich icon customization features:
...
This ensures EC Switch and CLI tool configurations stay in sync.
...
When adding a provider, EC Switch automatically extracts endpoint URLs from the configuration.
