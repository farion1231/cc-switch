...
CC Doctor provides rich icon customization features:
...
This ensures CC Doctor and CLI tool configurations stay in sync.
...
When adding a provider, CC Doctor automatically extracts endpoint URLs from the configuration.
