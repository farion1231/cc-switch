...
$XDG_CONFIG_HOME/Claude-3p/claude_desktop_config.json
$XDG_CONFIG_HOME/Claude-3p/configLibrary/_meta.json
$XDG_CONFIG_HOME/Claude-3p/configLibrary/00000000-0000-4000-8000-000000157210.json
```

When `XDG_CONFIG_HOME` is unset, CC Switch uses `~/.config`.
...
|---------|---------------|
| Current platform is not supported | 3P configuration writing is not implemented for this operating system |
