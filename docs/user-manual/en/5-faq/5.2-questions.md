...
**Fix**: Edit the Codex provider and check the **Enable Codex memories** toggle (between **Enable remote compaction** and **Write Common Config**); cc-switch will sync the active `model` into the `[memories]` table. See [2.7 Codex Memories / Chronicle](../2-providers/2.7-codex-memories.md).
