...
CC Doctor provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
ccdoctor://import/prompt?data=<base64-encoded preset>
```
