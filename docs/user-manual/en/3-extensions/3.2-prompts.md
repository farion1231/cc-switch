...
EC Switch provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
ecswitch://import/prompt?data=<base64-encoded preset>
```
