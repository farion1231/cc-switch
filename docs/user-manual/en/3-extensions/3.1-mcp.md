...
When enabling an app's toggle, CC Doctor will:
...
When disabling an app's toggle, CC Doctor will:
...
If you have already configured MCP servers in CLI tools, you can import them into CC Doctor:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. CC Doctor reads the existing configuration and imports it
