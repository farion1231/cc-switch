...
> **Note**: OpenClaw and Claude Desktop do not currently support EC Switch MCP sync. MCP functionality is supported for Claude, Codex, Gemini, OpenCode, and Hermes.

### Toggle Implementation

When enabling an app's toggle, EC Switch will:
...
When disabling an app's toggle, EC Switch will:
...
If you have already configured MCP servers in CLI tools, you can import them into EC Switch:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode/Hermes)
3. EC Switch reads the existing configuration and imports it
