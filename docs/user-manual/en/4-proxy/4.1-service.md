...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (CC Doctor)
...
After starting the proxy and enabling app takeover, CC Doctor modifies app configurations:
...
When stopping the proxy, CC Doctor will:
