...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (EC Switch)
...
After starting the proxy and enabling app takeover, EC Switch modifies app configurations:
...
When stopping the proxy, EC Switch will:
