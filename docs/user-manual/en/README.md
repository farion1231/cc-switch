...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | CC Doctor storage, CLI configuration file formats |
...
- Applicable to CC Doctor v3.13.0+
...
- [GitHub Issues](https://github.com/diaojz/cc-doctor/issues)
- [GitHub Repository](https://github.com/diaojz/cc-doctor)
