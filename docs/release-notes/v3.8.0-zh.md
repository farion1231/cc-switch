...
CC Doctor v3.8.0 是一次重大的架构升级版本，重构了数据持久化层和用户界面，为未来的云同步和本地代理功能奠定基础。
...
- **Windows**：`CC-Doctor-v3.8.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`CC-Doctor-v3.8.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`CC-Doctor-v3.8.0-Linux.AppImage` 或 `.deb`
...
- [@diaojz](https://github.com/diaojz) - BUG 修复和功能增强
- 社区成员的测试和反馈
