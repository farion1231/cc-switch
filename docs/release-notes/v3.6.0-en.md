...
**[中文更新说明 Chinese Documentation →](https://github.com/diaojz/cc-doctor/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `CC-Doctor-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `CC-Doctor-v3.6.0-Windows.msi`
- **Portable**: `CC-Doctor-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `CC-Doctor-v3.6.0-Linux.AppImage`
- **Debian**: `CC-Doctor-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/diaojz/cc-doctor/compare/v3.5.1...v3.6.0
