...
EC Switch v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
[Use code "ec-switch" for 10% off registration](https://www.packyapi.com/register?aff=ec-switch)
...
- **Issue Reports**: [GitHub Issues](https://github.com/farion1231/ec-switch/issues)
