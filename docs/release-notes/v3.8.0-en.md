...
CC Doctor v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `CC-Doctor-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `CC-Doctor-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `CC-Doctor-v3.8.0-Linux.AppImage` or `.deb`
...
- [@diaojz](https://github.com/diaojz) - Bug fixes and feature enhancements
...
[Use code "cc-doctor" for 10% off registration](https://www.packyapi.com/register?aff=cc-doctor)
...
- **Issue Reports**: [GitHub Issues](https://github.com/diaojz/cc-doctor/issues)
