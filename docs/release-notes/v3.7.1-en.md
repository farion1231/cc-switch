...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S cc-doctor-bin`
...
Visit [Releases](https://github.com/diaojz/cc-doctor/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `ccdoctor://` protocol
...
v3.7.0 represents a shift in CC Doctor's positioning:
...
Visit [Releases](https://github.com/diaojz/cc-doctor/releases/latest) to download:

- **Windows**: `CC-Doctor-Windows.msi` or `-Portable.zip`
- **macOS**: `CC-Doctor-macOS.tar.gz` or `.zip`
- **Linux**: `CC-Doctor-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S cc-doctor-bin`
...
- [@diaojz](https://github.com/diaojz) - From developer to issue responder
...
[Register with "cc-doctor" code for 10% discount](https://www.packyapi.com/register?aff=cc-doctor)
...
- **Issues**: [GitHub Issues](https://github.com/diaojz/cc-doctor/issues)
- **Discussions**: [GitHub Discussions](https://github.com/diaojz/cc-doctor/discussions)
