...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S ec-switch-bin`
...
Visit [Releases](https://github.com/farion1231/ec-switch/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `ecswitch://` protocol
...
v3.7.0 represents a shift in EC Switch's positioning:
...
[Register with "ec-switch" code for 10% discount](https://www.packyapi.com/register?aff=ec-switch)
...
- **Issues**: [GitHub Issues](https://github.com/farion1231/ec-switch/issues)
- **Discussions**: [GitHub Discussions](https://github.com/farion1231/ec-switch/discussions)
