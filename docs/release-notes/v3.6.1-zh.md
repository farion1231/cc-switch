...
- [中文文档](https://github.com/farion1231/ec-switch/blob/main/README_ZH.md)
- [English Documentation](https://github.com/farion1231/ec-switch/blob/main/README.md)
- [完整更新日志](https://github.com/farion1231/ec-switch/blob/main/CHANGELOG.md)
...
**完整变更记录**: https://github.com/farion1231/ec-switch/compare/v3.6.0...v3.6.1
...
EC Switch 是一个跨平台桌面应用，用于管理和切换 Claude Code 与 Codex 的不同供应商配置。基于 Tauri 2.0 + React 18 + TypeScript 构建，支持 Windows、macOS、Linux。
...
**项目地址**: https://github.com/farion1231/ec-switch
