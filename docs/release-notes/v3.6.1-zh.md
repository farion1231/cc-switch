...
- 从下方 [Assets](#assets) 下载 `CC-Doctor-v3.6.1-macOS.zip`

> **注意**：由于作者没有苹果开发者账号，首次打开可能出现"未知开发者"警告。请前往"系统设置" → "隐私与安全性" → 点击"仍要打开"

#### Windows

- **安装包**：`CC-Doctor-v3.6.1-Windows.msi`
- **便携版**：`CC-Doctor-v3.6.1-Windows-Portable.zip`
...
- [中文文档](https://github.com/diaojz/cc-doctor/blob/main/README_ZH.md)
- [English Documentation](https://github.com/diaojz/cc-doctor/blob/main/README.md)
- [完整更新日志](https://github.com/diaojz/cc-doctor/blob/main/CHANGELOG.md)
...
**完整变更记录**: https://github.com/diaojz/cc-doctor/compare/v3.6.0...v3.6.1
...
CC Doctor 是一个跨平台桌面应用，用于管理和切换 Claude Code 与 Codex 的不同供应商配置。基于 Tauri 2.0 + React 18 + TypeScript 构建，支持 Windows、macOS、Linux。
...
**项目地址**: https://github.com/diaojz/cc-doctor
