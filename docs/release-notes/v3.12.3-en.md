...
Added full reverse proxy support for GitHub Copilot, enabling Copilot-authenticated requests to be forwarded through CC Doctor.
...
- Backups stored in `~/.cc-doctor/skill-backups/` with all skill files and a `meta.json` containing original metadata
...
Users enable this feature **at their own risk**. CC Doctor is not responsible for any account restrictions, warnings, or service suspensions resulting from the use of this feature.
...
| File                                       | Description                                          |
| ------------------------------------------ | ---------------------------------------------------- |
| `CC-Doctor-v3.12.3-Windows.msi`            | **Recommended** - MSI installer with auto-update     |
| `CC-Doctor-v3.12.3-Windows-Portable.zip`   | Portable version, extract and run, no registry write |

### macOS

| File                               | Description                                                          |
| ---------------------------------- | -------------------------------------------------------------------- |
| `CC-Doctor-v3.12.3-macOS.dmg`     | **Recommended** - DMG installer, drag to Applications, Universal Binary |
| `CC-Doctor-v3.12.3-macOS.zip`     | ZIP archive, extract and drag to Applications, Universal Binary      |
| `CC-Doctor-v3.12.3-macOS.tar.gz`  | For Homebrew installation and auto-update                            |
