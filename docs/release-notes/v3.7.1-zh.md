...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S ec-switch-bin`
...
访问 [Releases](https://github.com/farion1231/ec-switch/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/farion1231/ec-switch/releases/latest) 下载：
...
[使用 "ec-switch" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=ec-switch)
...
- **问题反馈**：[GitHub Issues](https://github.com/farion1231/ec-switch/issues)
- **讨论**：[GitHub Discussions](https://github.com/farion1231/ec-switch/discussions)
