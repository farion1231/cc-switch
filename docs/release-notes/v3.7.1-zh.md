...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S cc-doctor-bin`
...
访问 [Releases](https://github.com/diaojz/cc-doctor/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/diaojz/cc-doctor/releases/latest) 下载：

- **Windows**：`CC-Doctor-Windows.msi` 或 `-Portable.zip`
- **macOS**：`CC-Doctor-macOS.tar.gz` 或 `.zip`
- **Linux**：`CC-Doctor-Linux.AppImage` 或 `.deb`
...
- [@diaojz](https://github.com/diaojz) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
[使用 "cc-doctor" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=cc-doctor)
...
- **问题反馈**：[GitHub Issues](https://github.com/diaojz/cc-doctor/issues)
- **讨论**：[GitHub Discussions](https://github.com/diaojz/cc-doctor/discussions)
