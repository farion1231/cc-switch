...
CC Doctor v3.7.0 新增六大核心功能，新增超过 18,000 行代码。
...
- **Windows**：`CC-Doctor-v3.7.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`CC-Doctor-v3.7.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`CC-Doctor-v3.7.0-Linux.AppImage` 或 `.deb`
...
[使用 "cc-doctor" 代码注册可享受 10% 折扣](https://www.packyapi.com/register?aff=cc-doctor)
