...
| File                                     | Description                                          |
| ---------------------------------------- | ---------------------------------------------------- |
| `CC-Doctor-v3.11.0-Windows.msi`          | **Recommended** - MSI installer with auto-update     |
| `CC-Doctor-v3.11.0-Windows-Portable.zip` | Portable version, extract and run, no registry write |

### macOS

| File                             | Description                                                          |
| -------------------------------- | -------------------------------------------------------------------- |
| `CC-Doctor-v3.11.0-macOS.zip`    | **Recommended** - Extract and drag to Applications, Universal Binary |
| `CC-Doctor-v3.11.0-macOS.tar.gz` | For Homebrew installation and auto-update                            |
