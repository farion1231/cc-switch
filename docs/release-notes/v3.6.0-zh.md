...
- 从下方 [Assets](#assets) 下载 `CC-Doctor-v3.6.0-macOS.zip`

> **注意**：由于作者没有苹果开发者账号，首次打开可能出现"未知开发者"警告。请前往"系统设置" → "隐私与安全性" → 点击"仍要打开"

### Windows

- **安装包**：`CC-Doctor-v3.6.0-Windows.msi`
- **便携版**：`CC-Doctor-v3.6.0-Windows-Portable.zip`
...
**完整变更记录**: https://github.com/diaojz/cc-doctor/compare/v3.5.1...v3.6.0
