...
**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/ec-switch/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- [中文文档 (Chinese)](https://github.com/farion1231/ec-switch/blob/main/README_ZH.md)
- [English Documentation](https://github.com/farion1231/ec-switch/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/farion1231/ec-switch/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/farion1231/ec-switch/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize EC Switch's configuration storage directory
...
EC Switch is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/farion1231/ec-switch
