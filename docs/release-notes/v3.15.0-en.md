...
>
> EC Switch is a **fully free and open-source** desktop app, and we **do not charge users any fees**. Multiple imposter websites have recently been spotted impersonating EC Switch to solicit payments and harvest account credentials, with some users already reporting financial losses. Please only obtain the software through the official channels listed below:
>
> | Channel            | Only Official                                                                  |
> | ------------------ | ------------------------------------------------------------------------------ |
> | Website            | **[ecswitch.io](https://ecswitch.io)**                                         |
> | Source             | **[github.com/farion1231/ec-switch](https://github.com/farion1231/ec-switch)** |
> | Downloads          | **[GitHub Releases](https://github.com/farion1231/ec-switch/releases)**        |
> | Author             | **[@farion1231](https://github.com/farion1231)**                               |
> | Report an Imposter | **[GitHub Issues](https://github.com/farion1231/ec-switch/issues)**            |
>
> **Any "EC Switch" website or client that asks you for payment, top-ups, or login credentials is fake.** If you have been tricked into paying, stop the transaction immediately and file a report through GitHub Issues so we can take down the imposter site as quickly as possible.
...
**[Use EC Switch to configure, manage, and switch Claude Desktop providers in one place](../user-manual/en/2-providers/2.6-claude-desktop.md)**
...
EC Switch now treats **Claude Desktop** as a first-class managed surface alongside Claude Code / Codex / Gemini / OpenCode / OpenClaw / Hermes.

- New dedicated Claude Desktop panel that brokers third-party providers to Claude Desktop through EC Switch's in-app proxy gateway
...
ChatGPT Codex providers no longer rely on a hardcoded model selection — EC Switch fetches a **live model list** from the ChatGPT backend on demand.
...
Switching a Claude Desktop provider writes EC Switch's managed 3P profile and **requires restarting Claude Desktop** to take effect; proxy-mode providers require EC Switch's Local Routing to stay running while in use.
...
### EC Switch Brand Surface Unified to ecswitch.io

All in-app and README "official website" references now point at ecswitch.io as the sole official site; the release notes template also surfaces ecswitch.io.
...
The release notes template now surfaces `ecswitch.io`.

### Brand Surface

Documented `ecswitch.io` as the sole official website across READMEs and in-app references.
...
**Claude Desktop Third-Party Provider Switching via Proxy Gateway**: Routing Claude Desktop traffic through EC Switch's in-app proxy gateway to a third-party provider exposes those requests to that provider's billing, compliance, and data-retention policies — read the target provider's terms of service before using.

By enabling these features, users **accept all associated risks**. EC Switch is not responsible for any account restrictions, warnings, or service suspensions that result from using these features.

---

## Download & Installation

Visit [Releases](https://github.com/farion1231/ec-switch/releases/latest) to download the appropriate version.
...
> 🎉 EC Switch is now available in the official Homebrew cask repository — no need to add a custom tap!
