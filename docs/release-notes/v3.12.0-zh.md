...
CC Doctor v3.12.0 是一个功能版本，重点提升供应商兼容性、OpenClaw 配置编辑体验、通用配置功能使用体验，以及同步与数据维护能力。本次恢复了增强稳定性后的 **模型健康检查（Stream Check）** UI，新增 **OpenAI Responses API** 格式转换，扩展了 **Ucloud**、**Micu**、**X-Code API**、**Novita**、**Bailian For Coding** 等供应商预设，并为 **WebDAV 同步** 引入双层版本控制。
...
| 文件                                     | 说明                                |
| ---------------------------------------- | ----------------------------------- |
| `CC-Doctor-v3.12.0-Windows.msi`          | **推荐** - MSI 安装包，支持自动更新 |
| `CC-Doctor-v3.12.0-Windows-Portable.zip` | 便携版，解压即用，不写入注册表      |

### macOS

| 文件                             | 说明                                                      |
| -------------------------------- | --------------------------------------------------------- |
| `CC-Doctor-v3.12.0-macOS.zip`    | **推荐** - 解压后拖入 Applications 即可，Universal Binary |
| `CC-Doctor-v3.12.0-macOS.tar.gz` | 用于 Homebrew 安装和自动更新                              |
