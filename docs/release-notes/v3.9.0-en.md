...
CC Doctor v3.9.0 is the stable release of the v3.9 beta series (`3.9.0-1`, `3.9.0-2`, `3.9.0-3`).
...
- SQL import is restricted to CC Doctor exported backups to reduce the risk of importing unsafe or incompatible SQL dumps.
- Proxy takeover modifies CLI live configs; CC Doctor will back up the live config before redirecting it to the local proxy. If you want to revert, disable takeover/stop the proxy and restore from the backup when needed.
...
| File                                    | Description                                        |
| --------------------------------------- | -------------------------------------------------- |
| `CC-Doctor-v3.9.0-Windows.msi`          | **Recommended** - MSI installer with auto-update support |
| `CC-Doctor-v3.9.0-Windows-Portable.zip` | Portable version, no installation required         |

### macOS

| File                            | Description                                                       |
| ------------------------------- | ----------------------------------------------------------------- |
| `CC-Doctor-v3.9.0-macOS.zip`    | **Recommended** - Extract and drag to Applications, Universal Binary |
| `CC-Doctor-v3.9.0-macOS.tar.gz` | For Homebrew installation and auto-update                         |
...
| Other distros / Unsure                  | `.AppImage`        | `chmod +x CC-Doctor-*.AppImage && ./CC-Doctor-*.AppImage`              |
| Sandboxed installation                  | `.flatpak`         | `flatpak install CC-Doctor-*.flatpak`                                  |
