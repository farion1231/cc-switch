...
- 备份存储在 `~/.cc-doctor/skill-backups/`，包含所有 skill 文件和记录原始元数据的 `meta.json`
- 旧备份自动清理，最多保留 20 个
- 备份路径返回前端并在成功提示中显示
...
用户启用此功能即表示**自行承担所有风险**。CC Doctor 不对因使用此功能而导致的任何账号限制、警告或服务暂停承担责任。
...
| 文件                                       | 说明                                |
| ------------------------------------------ | ----------------------------------- |
| `CC-Doctor-v3.12.3-Windows.msi`            | **推荐** - MSI 安装包，支持自动更新 |
| `CC-Doctor-v3.12.3-Windows-Portable.zip`   | 便携版，解压即用，不写入注册表      |

### macOS

| 文件                               | 说明                                                      |
| ---------------------------------- | --------------------------------------------------------- |
| `CC-Doctor-v3.12.3-macOS.dmg`     | **推荐** - DMG 安装包，拖入 Applications 即可             |
| `CC-Doctor-v3.12.3-macOS.zip`     | 解压后拖入 Applications，Universal Binary                 |
| `CC-Doctor-v3.12.3-macOS.tar.gz`  | 用于 Homebrew 安装和自动更新                              |
