...
CC Doctor v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/diaojz/cc-doctor/releases/latest) から入手:

- **Windows**: `CC-Doctor-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `CC-Doctor-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `CC-Doctor-v3.8.0-Linux.AppImage` または `.deb`
...
- [@diaojz](https://github.com/diaojz) - バグ修正と機能拡張
...
[登録時に「cc-doctor」で 10% オフ](https://www.packyapi.com/register?aff=cc-doctor)
...
- **Issue**: [GitHub Issues](https://github.com/diaojz/cc-doctor/issues)
