...
EC Switch v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/farion1231/ec-switch/releases/latest) から入手:
...
[登録時に「ec-switch」で 10% オフ](https://www.packyapi.com/register?aff=ec-switch)
...
- **Issue**: [GitHub Issues](https://github.com/farion1231/ec-switch/issues)
