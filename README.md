...
- **Skills** — One-click install from GitHub repos or ZIP files, custom repository management, filter installed skills by source, with symlink and file copy support
