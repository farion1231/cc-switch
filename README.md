...
### The All-in-One Manager for Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, OpenClaw, Hermes Agent & MiniMax Code
...
Modern AI-powered coding relies on tools like Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, OpenClaw, Hermes, and MiniMax Code — but each has its own configuration format. Switching API providers means manually editing JSON, TOML, or `.env` files, and there is no unified way to manage MCP and Skills across multiple tools.
...
- **One App, Eleven Tools** — Manage Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, OpenClaw, Hermes, and MiniMax Code from a single interface
- **No More Manual Editing** — 50+ provider presets including AWS Bedrock, NVIDIA NIM, and community relays; just pick and switch
- **Unified MCP & Skills Management** — One panel to manage MCP servers and Skills across Claude, Codex, Gemini, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, Hermes, and MiniMax Code with bidirectional sync
...
- **11 supported tools, 50+ presets** — Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, OpenClaw, Hermes, MiniMax Code; copy your key and import with one click
...
- **Unified MCP panel** — Manage MCP servers across Claude, Codex, Gemini, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, Hermes, and MiniMax Code with bidirectional sync and Deep Link import
...
CC Switch supports eleven tools: **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **Grok Build**, **OpenCode**, **VS Code Copilot**, **GitHub Copilot CLI**, **OpenClaw**, **Hermes**, and **MiniMax Code**. Each tool has dedicated provider presets and configuration management. **VS Code Copilot** and **GitHub Copilot CLI** are independent first-class applications with separate provider catalogs and sessions; the GitHub Copilot desktop app is not managed here.
