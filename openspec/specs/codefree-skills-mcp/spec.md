...
Define skills symlink management and MCP configuration management for CodeFree-O within CC Switch, including directory paths, config file handling, and UI panel integration.
