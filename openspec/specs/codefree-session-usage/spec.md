# CodeFree Session Usage

## Purpose

Define usage tracking and token cost calculation for CodeFree-O sessions within CC Switch, including database path discovery, session synchronization, and usage stats aggregation.
