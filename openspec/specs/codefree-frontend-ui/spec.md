# CodeFree Frontend UI

## Purpose

Define the frontend UI integration for CodeFree-O within CC Switch, including AppType registration, navigation behavior, icon display, and settings configuration.
