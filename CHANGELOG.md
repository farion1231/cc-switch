...
- Sync the Agent scheduling fork with upstream CC Switch v3.16.0 while preserving Agent Gateway, diagnostics, OpenCode subscription, and Claude takeover safeguards.
- Build Windows release artifacts for the forked v3.16.1 distribution.
