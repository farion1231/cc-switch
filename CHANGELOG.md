- [2026-06-01 15:56] FIX: 合并上游 provider 用量凭证解析后补齐 Pi Agent 顶层 baseUrl/apiKey 解析分支并增加回归测试 (Files: src-tauri/src/provider.rs, CHANGELOG.md)
- [2026-06-01 02:54] FEAT: 按 Pi Agent 官方目录完整适配 MCP、Skills 与 Prompt Templates，同步数据库启用状态并开放前端入口 (Files: src-tauri/src/mcp/pi.rs, src-tauri/src/mcp/mod.rs, src-tauri/src/services/mcp.rs, src-tauri/src/services/skill.rs, src-tauri/src/pi_config.rs, src-tauri/src/prompt_files.rs, src-tauri/src/app_config.rs, src-tauri/src/database/schema.rs, src-tauri/src/database/dao/mcp.rs, src-tauri/src/database/dao/skills.rs, src/App.tsx, src/components/mcp/McpFormModal.tsx, src/components/skills/UnifiedSkillsPanel.tsx, src/config/appConfig.tsx)
- [2026-06-01 01:01] FEAT: 在关于页本地环境检查中加入 Pi Agent CLI 版本、安装冲突诊断、安装/升级命令与环境变量冲突扫描 (Files: src/components/settings/AboutSection.tsx, src-tauri/src/commands/misc.rs, src-tauri/src/services/env_checker.rs, src/lib/api/env.ts, src/i18n/locales/zh.json, src/i18n/locales/en.json, src/i18n/locales/ja.json, src/i18n/locales/zh-TW.json)
...
- [2026-05-31 22:26] FEAT: 完整适配 Pi Agent 中转路由供应商配置、live models.json 同步、默认供应商切换与前端供应商管理 (Files: src-tauri/src/app_config.rs, src-tauri/src/pi_config.rs, src-tauri/src/commands/pi.rs, src-tauri/src/commands/config.rs, src-tauri/src/services/provider/live.rs, src-tauri/src/services/provider/mod.rs, src-tauri/src/services/stream_check.rs, src-tauri/src/settings.rs, src/App.tsx, src/hooks/useProviderActions.ts, src/components/providers/ProviderList.tsx, src/components/providers/AddProviderDialog.tsx, src/components/providers/EditProviderDialog.tsx, src/components/providers/ProviderActions.tsx, src/components/providers/ProviderCard.tsx, src/components/providers/forms/ProviderForm.tsx, src/components/providers/forms/helpers/opencodeFormUtils.ts, src/components/providers/forms/hooks/useOpenclawFormState.ts, src/lib/api/providers.ts, src/lib/query/mutations.ts, src/lib/query/queries.ts)
