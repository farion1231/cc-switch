...
export const subscriptionApi = {
  getQuota: (tool: string, scopeKey = "active"): Promise<SubscriptionQuota> =>
    invoke("get_subscription_quota", { tool, scopeKey }),
  getCodexOauthQuota: (accountId: string): Promise<SubscriptionQuota> =>
