...
export const settingsSchema = z.object({
  ...
  enableClaudeBackgroundNotifications: z.boolean().optional(),
  enableClaudePermissionPromptNotifications: z.boolean().optional(),
  enableClaudeRoundCompleteNotifications: z.boolean().optional(),
  claudeNotifyPort: z.number().int().min(1024).max(65535).optional(),
