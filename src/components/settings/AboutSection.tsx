...
const OMP_WINDOWS_INSTALL_SCRIPT = "irm https://omp.sh/install.ps1 | iex";
const OMP_WINDOWS_INSTALL_COMMAND = `powershell -NoProfile -ExecutionPolicy Bypass -EncodedCommand ${powershellEncodedCommand(
  OMP_WINDOWS_INSTALL_SCRIPT,
)}`;
...
# OMP
${posixScriptInstallCommand("https://omp.sh/install")} || npm i -g @oh-my-pi/pi-coding-agent@latest`;
...
npm i -g @earendil-works/pi-coding-agent@latest
# OMP
${OMP_WINDOWS_INSTALL_COMMAND} || npm i -g @oh-my-pi/pi-coding-agent@latest`;
