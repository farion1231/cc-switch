          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <Label>{t("skills.repo.sourceType")}</Label>
              ...
              {sourceType === "zipUrl" && (
                <>
                  <div className="space-y-2">
                    <Label htmlFor="zip-url">{t("skills.repo.zipUrl")}</Label>
                    <Input
                      id="zip-url"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="repo-id">{t("skills.repo.id")}</Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="website-url">{t("skills.repo.websiteUrl")}</Label>
                    <Input
                      id="website-url"
              ...
              <Button onClick={handleAdd} variant="mcp" type="button">
