...
type ClaudeManagedProviderType = "github_copilot" | "codex_oauth" | "xai_oauth";
...
function ProviderFormFull({
  ...
  const managedProviderType = resolveClaudeManagedProviderType({
    ...
    templateProviderType: templatePreset?.providerType ?? presetProviderType,
  });
  ...
  const isManagedXaiOauthProvider = managedProviderType === "xai_oauth";
  ...
  const handleSubmit = async (values: ProviderFormData) => {
    ...
    const isXaiOauthProvider = isManagedXaiOauthProvider;
        ...
        >
          ...
          {appId === "claude" && (
            <ClaudeFormFields
              ...
              isXaiOauthPreset={isManagedXaiOauthProvider}
              usesOAuth={
