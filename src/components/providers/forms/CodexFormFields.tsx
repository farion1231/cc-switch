...
type CodexCustomModelRow = CodexCustomModel & { rowId: string };
...
>(row: T, upstreamModel: string, match?: CodexCatalogModel): T {
  return {
    ...
    reasoningLevels: match?.reasoningLevels
      ? [...match.reasoningLevels]
      : undefined,
    defaultReasoningLevel: match?.defaultReasoningLevel,
  };
}
...
export function CodexFormFields({
  ...
  // 模型名称（Codex 展示用）变化：只改对外 ID，不影响上游模型
