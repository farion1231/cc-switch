  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-2">
        ...
        {/* Name and badges */}
        {(() => {
          const showHealthBadge = isProxyRunning && isInFailoverQueue && health;
          const showPriorityBadge = isAutoFailoverEnabled && isInFailoverQueue && failoverPriority;
          const hasBadges = showHealthBadge || showPriorityBadge;
          ...
          return hasBadges ? (
            ...
            <div className="flex-1 min-w-0 flex items-center gap-1.5">
              ...
              {provider.category === "third_party" &&
                provider.meta?.isPartner && (
                  <span
                    className="text-yellow-500 dark:text-yellow-400 text-xs flex-shrink-0"
                    title={t("provider.officialPartner", {
                      defaultValue: "官方合作伙伴",
                    })}
                  >
