...
> = {
  ...
  qodercli: { key: "qodercli", defaultFolder: ".qoder" },
};
    ...
    const load = async () => {
      try {
        const [
          ...
          settingsApi.getConfigDir("qodercli"),
          ...
          computeDefaultConfigDir("qodercli"),
        ]);
        ...
        setResolvedDirs({
          ...
          qodercli: qodercliDir || defaultsRef.current.qodercli,
        });
      } catch (error) {
        console.error(
  ...
  const resetAllDirectories = useCallback(
    (overrides?: ResolvedAppDirectoryOverrides) => {
      ...
      setResolvedDirs({
        ...
        qodercli: overrides?.qodercli ?? defaultsRef.current.qodercli,
      });
    },
    [],
  );
