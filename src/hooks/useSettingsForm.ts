...
export function useSettingsForm(): UseSettingsFormResult {
  ...
  useEffect(() => {
    ...
    const normalized: SettingsFormState = {
      ...
      enableCodexLiveVoice: data.enableCodexLiveVoice ?? false,
      codexLiveVoiceRoute: data.codexLiveVoiceRoute ?? "official",
  ...
  const resetSettings = useCallback(
    (serverData: Settings | null) => {
      ...
      const normalized: SettingsFormState = {
        ...
        enableCodexLiveVoice: serverData.enableCodexLiveVoice ?? false,
        codexLiveVoiceRoute: serverData.codexLiveVoiceRoute ?? "official",
