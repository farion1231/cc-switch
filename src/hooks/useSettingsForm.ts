...
export function useSettingsForm(): UseSettingsFormResult {
  ...
  useEffect(() => {
    ...
    const normalized: SettingsFormState = {
      ...
      guardianIntervalSeconds: data.guardianIntervalSeconds ?? 60,
      legacyStartupMigrated: data.legacyStartupMigrated ?? false,
      startupItemsMode: data.startupItemsMode ?? "autoLaunch",
      ...
      setSettingsState((prev) => {
        const base =
          ...
          ({
            ...
            guardianIntervalSeconds: 60,
            legacyStartupMigrated: false,
            startupItemsMode: "autoLaunch",
  ...
  const resetSettings = useCallback(
    (serverData: Settings | null) => {
      ...
      const normalized: SettingsFormState = {
        ...
        guardianEnabled: serverData.guardianEnabled ?? false,
        guardianIntervalSeconds: serverData.guardianIntervalSeconds ?? 60,
        legacyStartupMigrated: serverData.legacyStartupMigrated ?? false,
        startupItemsMode: serverData.startupItemsMode ?? "autoLaunch",
