...
export const piProviderPresets: PiProviderPreset[] = [
  ...
  {
    name: "Google Gemini",
    nameKey: "providerForm.presets.gemini",
  ...
  {
    name: "智谱 GLM",
    nameKey: "providerForm.presets.zhipu_glm",
  ...
  {
    name: "智谱 GLM (国际版)",
    nameKey: "providerForm.presets.zhipu_glm_en",
  ...
  },
  {
    ...
    nameKey: "providerForm.presets.volcengine",
  ...
  {
    name: "BytePlus",
    nameKey: "providerForm.presets.byteplus",
  ...
  {
    name: "Longcat",
    nameKey: "providerForm.presets.longcat",
