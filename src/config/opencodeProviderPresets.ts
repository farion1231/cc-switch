  ...
  },
  {
    ...
    settingsConfig: {
      ...
      models: {
        ...
        "deepseek/deepseek-chat-v3.1": { name: "DeepSeek Chat V3.1" },
        "deepseek/deepseek-chat": { name: "DeepSeek Chat" },
        "deepseek/deepseek-r1": { name: "DeepSeek R1" },
        "qwen/qwen3-coder": { name: "Qwen3 Coder" },
        "qwen/qwen3-max-thinking": { name: "Qwen3 Max Thinking" },
        "qwen/qwen3-235b-a22b-2507": { name: "Qwen3 235B A22B 2507" },
        "qwen/qwen3-235b-a22b": { name: "Qwen3 235B A22B" },
        ...
        "meta-llama/llama-4-scout": { name: "Llama 4 Scout" },
