...
/** App IDs shown in Skills panels. StepCode has no skills registry yet. */
export type SkillsAppId = Exclude<AppId, "stepcode">;
...
export type AdditiveAppId = Extract<
  AppId,
  "opencode" | "openclaw" | "hermes" | "pi" | "mcode" | "stepcode"
>;
...
export type McpAppId = Exclude<
  AppId,
  "claude-desktop" | "openclaw" | "pi" | "stepcode"
>;
