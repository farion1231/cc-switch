...
base_url = "https://cc-api.pipellm.ai/v1"`,
  ...
  },
  {
    ...
    config: generateThirdPartyConfig(
      "cocodot",
      "https://cocodot.co/api/ai/v1",
      "mcs-6",
    ),
    endpointCandidates: ["https://cocodot.co/api/ai/v1"],
    apiFormat: "openai_chat",
    modelCatalog: modelCatalog([
      { model: "mcs-6", displayName: "Claude Sonnet 5" },
      { model: "mco-6", displayName: "Claude Opus 4.8" },
      { model: "mog-8-s", displayName: "GPT-5.6 Sol" },
      { model: "mog-8-t", displayName: "GPT-5.6 Terra" },
      { model: "mog-8-l", displayName: "GPT-5.6 Luna" },
    ]),
    category: "aggregator",
    icon: "cocodot",
    iconColor: "#2F6BFF",
