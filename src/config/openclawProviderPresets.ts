...
export const openclawProviderPresets: OpenClawProviderPreset[] = [
  ...
  },
  {
    ...
    suggestedDefaults: {
      model: {
        primary: "wavespeed/google/gemini-2.5-flash",
        fallbacks: ["wavespeed/google/gemini-2.5-flash-lite"],
      },
      modelCatalog: {
        "wavespeed/google/gemini-2.5-flash": { alias: "Gemini Flash" },
        "wavespeed/google/gemini-2.5-flash-lite": {
