...
import { providersApi, type ProviderSwitchEvent } from "@/lib/api";
...
/**
 * 后端事件订阅：供应商切换 / 统一供应商同步 / WebDAV & S3 同步状态 / 代理告警。
 */
export function useAppEvents(activeApp: AppId, refetchProviders: () => Promise<unknown>) {
