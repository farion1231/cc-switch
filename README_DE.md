...
### Der All-in-One-Manager für Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, OpenClaw, Hermes Agent & MiniMax Code
...
- **Eine App, elf Werkzeuge** — Verwalten Sie Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, OpenClaw, Hermes und MiniMax Code über eine einzige Oberfläche
...
- **Einheitliche MCP- & Skills-Verwaltung** — Ein Panel zur Verwaltung von MCP-Servern und Skills für Claude, Codex, Gemini, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, Hermes und MiniMax Code mit bidirektionaler Synchronisierung
...
- **11 unterstützte Werkzeuge, 50+ Presets** — Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, OpenClaw, Hermes, MiniMax Code; Schlüssel kopieren und mit einem Klick importieren
...
- **Einheitliches MCP-Panel** — Verwalten Sie MCP-Server für Claude, Codex, Gemini, Grok Build, OpenCode, VS Code Copilot, GitHub Copilot CLI, Hermes und MiniMax Code mit bidirektionaler Synchronisierung und Deep-Link-Import
...
CC Switch unterstützt elf Werkzeuge: **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **Grok Build**, **OpenCode**, **VS Code Copilot**, **GitHub Copilot CLI**, **OpenClaw** **Hermes** und **MiniMax Code**. Jedes Werkzeug verfügt über dedizierte Anbieter-Presets und Konfigurationsverwaltung. **VS Code Copilot** und **GitHub Copilot CLI** sind zwei unabhängige First-Class-Anwendungen mit getrennten Anbieterkatalogen und Sitzungen; die GitHub-Copilot-Desktop-App wird hier nicht verwaltet.
