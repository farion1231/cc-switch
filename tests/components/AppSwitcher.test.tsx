...
describe("AppSwitcher", () => {
  ...
  it("desaturates the VS Code Copilot image only while inactive", () => {
    const onSwitch = vi.fn();
    ...
    const image = () =>
      screen
        .getByRole("button", { name: "VS Code Copilot" })
        .querySelector("img");

    expect(image()).toHaveClass("grayscale", "opacity-60");
    rerender(<AppSwitcher activeApp="copilot-byok" onSwitch={onSwitch} />);
