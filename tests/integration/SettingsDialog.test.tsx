...
describe("SettingsPage integration", () => {
  it("loads default settings from MSW", async () => {
    ...
    expect((appInput as HTMLInputElement).value).toBe("/home/mock/.cc-doctor");
  });
  ...
  it("allows browsing and resetting directories", async () => {
    ...
    expect(appInput.value).toBe("/home/mock/.cc-doctor");

    fireEvent.click(browseButtons[0]);
    await waitFor(() =>
      expect(appInput.value).toBe("/home/mock/.cc-doctor/picked"),
    );

    fireEvent.click(resetButtons[0]);
    await waitFor(() => expect(appInput.value).toBe("/home/mock/.cc-doctor"));
